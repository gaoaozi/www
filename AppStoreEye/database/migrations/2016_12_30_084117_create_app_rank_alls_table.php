...
class CreateAppRankAllsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('app_rank_all', function (Blueprint $table) {
...
//            $table->timestamp('updated_at')->comment("记录更新时间");
//            $table->timestamp('created_at')->comment("记录创建时间");
    ...
    {
        Schema::dropIfExists('app_rank_all');
    }
}
