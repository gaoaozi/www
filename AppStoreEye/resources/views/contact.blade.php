			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						<h3>联系方式</h3>
						<ul>
							<li class="address">北京市海淀区 <br> 正源尚峰尚水C区1号楼327室</li>
							<li class="phone"><a href="tel://13269575296">+ 86 13269575296</a></li>
							<li class="email"><a href="mailto:gaz0301@163.com">gaz0301@163.com</a></li>
							<li class="url"><a href="http://163.com">XXX.com</a></li>
						</ul>
					</div>
					...
					<form action="#">
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" id="fname" class="form-control" placeholder="名字">
							</div>
							{{--<div class="col-md-6">--}}
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="告诉我们"></textarea>
							</div>
						</div>
